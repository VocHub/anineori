...
const Streams = () => {
  ...
  const corsProxy =  ['https://corsproxy-anikatsu.herokuapp.com/', 'https://cors.shreyasm2308.workers.dev/', 'https://cors.animem.workers.dev/', 'https://m3u8proxy.hambasahaya0303.workers.dev/?url='];
        ...
        <div className="bg-zinc-800 w-full p-1 rounded flex justify-between">
          ...
          <div className="flex gap-3 mr-4 text-zinc-300 justify-between items-center">
            <div className="hover:text-zinc-500">
              <a href={data?.download.replace("gogohd.net", "anihdplay.com")}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
        ...
        <div className="mx-1">
          {mainPlayer === "Internal Player" ? (
            <ReactPlayer
              ...
              url={corsProxy[1] + selectStream.url}
              onStart={() => {
